  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 bg-deep-charcoal rounded-lg flex items-center justify-center">
            <i className="fas fa-cube text-construction-orange text-xl"></i>
          </div>
          <span className="font-montserrat font-black text-2xl text-deep-charcoal">LOCKSTONE</span>
        </motion.div>
